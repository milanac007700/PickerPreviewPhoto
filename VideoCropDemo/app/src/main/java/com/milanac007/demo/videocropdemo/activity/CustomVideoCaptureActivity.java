...
import com.milanac007.demo.videocropdemo.ui.CustomHorizonalProgressBar;
import com.milanac007.demo.videocropdemo.ui.CustomVideoCaptureView;
import com.milanac007.demo.videocropdemo.ui.VideoCaptureButton;
import com.milanac007.demo.videocropdemo.ui.VoiceSendButton;
...
public class CustomVideoCaptureActivity extends Activity implements View.OnClickListener, CustomVideoCaptureView.VideoCaptureListener, VoiceSendButton.RecordListener {
    ...
    public static final int VIDEO_CAPTURE_CODE = 0xf0;
...
//        super.onBackPressed();
    ...
    public void onStartRecord() {
        ...
        showToast(getString(R.string.m_finger_slide_up));
...
//                //处理翻转信息
//                String vf = cameraId == Camera.CameraInfo.CAMERA_FACING_BACK ? "transpose=1" : "transpose=2,hflip";
//                cmd = String.format("ffmpeg -threads 4 -y -i %s -strict -2 -metadata:s:v rotate=\"0\" -vf %s,crop=480:480:0:0 -r 25 %s", inputFilePath, vf, outputFilePath);
//
...
//                compressThread();
                ...
                if(VideoFile != null && VideoFile.exists()){
                    ...
                    if(Build.VERSION.SDK_INT < 24) {
                        photoUri = Uri.fromFile(VideoFile);
                    }else {
                        photoUri = FileProvider.getUriForFile(CustomVideoCaptureActivity.this, getPackageName() + ".fileprovider", VideoFile);
                    }
                    Log.i(TAG, "##@@ photoUri: " + photoUri);

                    intent.setData(photoUri);
                    intent.putExtra("previewSize", "480x480");
    ...
    public void onFinishRecord() {
        ...
        if(mVideoCapturePreview != null){
            ...
            if(result < 0){         //TODO  时间太短处理
                showToast(getString(R.string.m_video_too_short));
            }else {
                //TODO 转码 ffmpeg 裁减
                CommonFunction.hideToast();
...
//                String inputFilePath = mVideoCapturePreview.getmVideoFile().getPath();
//                VideoFile = new File(inputFilePath);
//
//                Intent intent=new Intent();
//                if(VideoFile != null && VideoFile.exists()){
...
//                finish();
    ...
    public void onMoveLayout(boolean isInLayout) {
        if(isInLayout){
            showToast(getString(R.string.m_loosen_cancel));
        }else {
            showToast(getString(R.string.m_finger_slide_up));
        }
    ...
    private void showToast(final String msg) {
        Toast mToast = CommonFunction.getToast(msg);
